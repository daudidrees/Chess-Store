  ...
  describe('constructor', () => {
    ...
    it('should not process element without target', () => {
      fixtureEl.innerHTML = [
        ...
        '  <ul class="navbar-nav">',
        '    <li class="page_item"><a class="nav-link active" id="one-link" href="#">One</a></li>',
        '    <li class="page_item"><a class="nav-link" id="two-link" href="#two">Two</a></li>',
        '    <li class="page_item"><a class="nav-link" id="three-link" href="#three">Three</a></li>',
        '  </ul>',
        '</nav>',
    ...
    it('should only switch "active" class on current target', done => {
      fixtureEl.innerHTML = [
        ...
        '        <ul class="nav">',
        '          <li class="page_item"><a href="#masthead">Overview</a></li>',
        '          <li class="page_item"><a href="#detail">Detail</a></li>',
        '        </ul>',
        '      </div>',
        '    </div>',
        '  </div>',
    ...
    it('should correctly select middle navigation option when large offset is used', done => {
      fixtureEl.innerHTML = [
        ...
        '<nav id="navigation" class="navbar">',
        ' <ul class="navbar-nav">',
        '   <li class="page_item"><a class="nav-link active" id="one-link" href="#one">One</a></li>',
        '   <li class="page_item"><a class="nav-link" id="two-link" href="#two">Two</a></li>',
        '   <li class="page_item"><a class="nav-link" id="three-link" href="#three">Three</a></li>',
        ' </ul>',
        '</nav>',
    ...
    it('should add the active class to the correct element', done => {
      fixtureEl.innerHTML = [
        '<nav class="navbar">',
        '  <ul class="nav">',
        '    <li class="page_item"><a class="nav-link" id="a-1" href="#div-1">div 1</a></li>',
        '    <li class="page_item"><a class="nav-link" id="a-2" href="#div-2">div 2</a></li>',
        '  </ul>',
        '</nav>',
    ...
    it('should clear selection if above the first section', done => {
      fixtureEl.innerHTML = [
        ...
        '<nav id="navigation" class="navbar">',
        '  <ul class="navbar-nav">',
        '    <li class="page_item"><a id="one-link"   class="nav-link active" href="#one">One</a></li>',
        '    <li class="page_item"><a id="two-link"   class="nav-link" href="#two">Two</a></li>',
        '    <li class="page_item"><a id="three-link" class="nav-link" href="#three">Three</a></li>',
        '  </ul>',
        '</nav>',
        '<div id="content" style="height: 200px; overflow-y: auto;">',
    ...
    it('should correctly select navigation element on backward scrolling when each target section height is 100%', done => {
      fixtureEl.innerHTML = [
        '<nav class="navbar">',
        '  <ul class="nav">',
        '    <li class="page_item"><a id="li-100-1" class="nav-link" href="#div-100-1">div 1</a></li>',
        '    <li class="page_item"><a id="li-100-2" class="nav-link" href="#div-100-2">div 2</a></li>',
        '    <li class="page_item"><a id="li-100-3" class="nav-link" href="#div-100-3">div 3</a></li>',
        '    <li class="page_item"><a id="li-100-4" class="nav-link" href="#div-100-4">div 4</a></li>',
        '    <li class="page_item"><a id="li-100-5" class="nav-link" href="#div-100-5">div 5</a></li>',
        '  </ul>',
        '</nav>',
    ...
    it('should allow passed in option offset method: offset', () => {
      fixtureEl.innerHTML = [
        '<nav class="navbar">',
        '  <ul class="nav">',
        '    <li class="page_item"><a id="li-jsm-1" class="nav-link" href="#div-jsm-1">div 1</a></li>',
        '    <li class="page_item"><a id="li-jsm-2" class="nav-link" href="#div-jsm-2">div 2</a></li>',
        '    <li class="page_item"><a id="li-jsm-3" class="nav-link" href="#div-jsm-3">div 3</a></li>',
        '  </ul>',
        '</nav>',
        '<div class="content"  style="position: relative; overflow: auto; height: 100px">',
